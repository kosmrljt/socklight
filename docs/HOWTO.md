# sockLight — How-To Guides

Practical step-by-step guides for common tasks. For command syntax see [COMMANDS.md](COMMANDS.md).

## Guides

| Guide | When to use |
|---|---|
| [Debug app traffic](howto-debug.md) | See what your app or container connects to, block unwanted calls |
